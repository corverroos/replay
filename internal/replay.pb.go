...
type SleepRequest struct {
	...
	AsyncToken           string             `protobuf:"bytes,2,opt,name=async_token,json=asyncToken,proto3" json:"async_token,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *SleepRequest) GetAsyncToken() string {
	if m != nil {
		return m.AsyncToken
	}
	return ""
...
var fileDescriptor_eed9461330ccfc03 = []byte{
	...
	0xe7, 0xa4, 0xa6, 0x16, 0xb8, 0xe4, 0xe7, 0xa5, 0x2a, 0xa5, 0x71, 0xf1, 0x80, 0x39, 0x41, 0xa9,
	...
	0x0a, 0xc9, 0x73, 0x71, 0x27, 0x16, 0x57, 0xe6, 0x25, 0xc7, 0x97, 0xe4, 0x67, 0xa7, 0xe6, 0x49,
	0x30, 0x29, 0x30, 0x6a, 0x70, 0x06, 0x71, 0x81, 0x85, 0x42, 0x40, 0x22, 0x49, 0x6c, 0x60, 0xdd,
	0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xed, 0x77, 0x78, 0xb5, 0xb5, 0x00, 0x00, 0x00,
}
