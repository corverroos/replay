...
func SignalFooS1(ctx context.Context, cl replay.Client, run string, message *Empty, extID string) error {
...
func SignalFooS2(ctx context.Context, cl replay.Client, run string, message *Int, extID string) error {
	return cl.SignalRun(ctx, _ns, _wFoo, run, _sFooS2, message, extID)
}

// RunFoo provides a type API for running the foo workflow.
func RunFoo(ctx context.Context, cl replay.Client, run string, message *String) error {
	return cl.RunWorkflow(ctx, _ns, _wFoo, run, message)
}

// RunBar provides a type API for running the bar workflow.
func RunBar(ctx context.Context, cl replay.Client, run string, message *Empty) error {
